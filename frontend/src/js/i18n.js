...
'adminUsers.title': 'إدارة المستخدمين',
            ...
            'adminUsers.rolePatient': 'مريض',
            'adminUsers.roleDoctor': 'طبيب',
            'adminUsers.roleAdmin': 'مشرف',
            'adminUsers.roleSuperAdmin': 'مشرف عام',
            'adminUsers.statusAll': 'كل الحالات',
            'adminUsers.statusActive': 'نشط',
            'adminUsers.statusInactive': 'غير نشط',
            'adminUsers.verified': 'موثّق',
            'adminUsers.unverified': 'غير موثّق',
            'adminUsers.deactivate': 'تعطيل',
            'adminUsers.reactivate': 'إعادة تفعيل',
            'adminUsers.confirmDeactivate': 'سيتم تعطيل حساب {name} وإنهاء جميع جلساته النشطة. هل تريد المتابعة؟',
            'adminUsers.confirmReactivate': 'سيتم إعادة تفعيل حساب {name}. هل تريد المتابعة؟',
            'adminUsers.currentAccount': 'حسابك الحالي',
            'adminUsers.protectedAccount': 'حساب محمي',
            'adminUsers.noUsers': 'لا يوجد مستخدمون مطابقون لهذه الفلاتر',
            'adminUsers.deactivateSuccess': 'تم تعطيل المستخدم',
            'adminUsers.reactivateSuccess': 'تمت إعادة تفعيل المستخدم',
            'adminUsers.operationFailed': 'تعذرت العملية',
            'adminUsers.loadError': 'تعذر تحميل قائمة المستخدمين',
...
'authModal.title': 'سجّل الدخول للمتابعة',
            ...
            'authModal.signIn': 'تسجيل الدخول',
            'authModal.close': 'إغلاق',
            'authModal.googleUnavailable': 'تعذّر تسجيل الدخول باستخدام جوجل. جرّب البريد الإلكتروني وكلمة المرور.',
            'authGate.checking': 'جارٍ التحقق من جلستك…',
            'authGate.offlineTitle': 'تعذّر التحقق من جلستك',
            'authGate.offlineDesc': 'لم نتمكن من الوصول إلى خدمة MedOrbit. لم يتم تسجيل خروجك — تحقق من اتصالك ثم أعد المحاولة.',
            'authGate.retry': 'إعادة المحاولة',
            'authGate.backHome': 'العودة إلى الرئيسية',
            'authGate.expired': 'انتهت جلستك. سجّل الدخول للمتابعة.',
...
'doctors.title': 'الأطباء',
            ...
            'doctors.acceptingOnly': 'المتاحون لاستقبال مرضى جدد فقط',
            'doctors.rating': 'التقييم',
            'doctors.anyRating': 'أي تقييم',
            'doctors.rating45': '4.5 فأعلى',
            'doctors.rating4': '4.0 فأعلى',
            'doctors.rating3': '3.0 فأعلى',
            'doctors.experienceRange': 'سنوات الخبرة',
            'doctors.priceRange': 'رسوم الكشف',
            'doctors.from': 'من',
            'doctors.to': 'إلى',
            'doctors.clearFilters': 'مسح التصفية',
...
'patientDetail.noIdTitle': 'لم يتم تحديد مريض',
            ...
            'patientDetail.sessionNotes': 'السجلات الطبية',
            'patientDetail.addNote': 'إضافة سجل طبي',
            'patientDetail.appointment': 'الموعد',
            ...
            'patientDetail.symptoms': 'الأعراض (مفصولة بفواصل)',
            'patientDetail.treatmentPlan': 'خطة العلاج',
            'patientDetail.prognosis': 'التوقعات',
            'patientDetail.clinicalNotes': 'ملاحظات إكلينيكية',
            'patientDetail.doctorNotes': 'ملاحظات داخلية (لا تظهر للمريض)',
            'patientDetail.saveDraft': 'حفظ كمسودة (غير مرئية للمريض)',
            'patientDetail.sharedBadge': 'مشتركة مع المريض',
            'patientDetail.saveNote': 'حفظ السجل',
            'patientDetail.prescriptions': 'الوصفات الطبية',
            'patientDetail.noAppointments': 'لا يوجد سجل مواعيد بعد',
            'patientDetail.noNotes': 'لا توجد سجلات طبية بعد',
            ...
            'patientDetail.noteSavedTitle': 'تم حفظ السجل',
            'patientDetail.noteSavedHint': 'تمت إضافة السجل الطبي إلى ملف المريض.',
            'patientDetail.noteErrorTitle': 'تعذر حفظ السجل',
            ...
            'patientDetail.editLoadError': 'تعذر تحميل بيانات السجل للتعديل',
            'patientDetail.saveChanges': 'حفظ التعديلات',
            'patientDetail.cancelEdit': 'إلغاء',
            'patientDetail.editSuccess': 'تم تحديث السجل',
            'patientDetail.editError': 'تعذر حفظ التعديلات',
            'patientDetail.deleteModalTitle': 'حذف السجل الطبي',
            'patientDetail.deleteModalHint': 'هل أنت متأكد من حذف هذا السجل؟ لا يمكن التراجع عن هذا الإجراء.',
            'patientDetail.deleteDismiss': 'إلغاء',
...
'adminUsers.title': 'User Management',
            ...
            'adminUsers.rolePatient': 'Patient',
            'adminUsers.roleDoctor': 'Doctor',
            'adminUsers.roleAdmin': 'Admin',
            'adminUsers.roleSuperAdmin': 'Super Admin',
            'adminUsers.statusAll': 'All statuses',
            ...
            'adminUsers.confirmDeactivate': '{name} will be deactivated and all active sessions will be signed out. Continue?',
            'adminUsers.confirmReactivate': '{name} will be reactivated. Continue?',
            'adminUsers.currentAccount': 'Current account',
            'adminUsers.protectedAccount': 'Protected account',
            'adminUsers.noUsers': 'No users match these filters',
            'adminUsers.deactivateSuccess': 'User deactivated',
            'adminUsers.reactivateSuccess': 'User reactivated',
            'adminUsers.operationFailed': 'Operation failed',
            'adminUsers.loadError': 'Unable to load users',
...
'authModal.title': 'Sign in to continue',
            ...
            'authModal.googleUnavailable': 'Google sign-in is unavailable right now. Try your email and password instead.',
            'authGate.checking': 'Verifying your session…',
            'authGate.offlineTitle': 'Could not verify your session',
            'authGate.offlineDesc': 'We could not reach the MedOrbit service. You have not been signed out — check your connection and try again.',
            'authGate.retry': 'Retry',
            'authGate.backHome': 'Back to Home',
            'authGate.expired': 'Your session has ended. Please sign in to continue.',
...
'doctors.title': 'Doctors',
            ...
            'doctors.acceptingOnly': 'Accepting new patients only',
            'doctors.rating': 'Rating',
            'doctors.anyRating': 'Any rating',
            'doctors.rating45': '4.5 and above',
            'doctors.rating4': '4.0 and above',
            'doctors.rating3': '3.0 and above',
            'doctors.experienceRange': 'Experience (years)',
            'doctors.priceRange': 'Consultation fee',
            'doctors.from': 'From',
            'doctors.to': 'To',
...
'patientDetail.noIdTitle': 'No patient selected',
            ...
            'patientDetail.sessionNotes': 'Medical Records',
            'patientDetail.addNote': 'Add Medical Record',
            'patientDetail.appointment': 'Appointment',
            ...
            'patientDetail.symptoms': 'Symptoms (comma-separated)',
            'patientDetail.treatmentPlan': 'Treatment Plan',
            'patientDetail.prognosis': 'Prognosis',
            'patientDetail.clinicalNotes': 'Clinical Notes',
            'patientDetail.doctorNotes': "Internal notes (not shown to the patient)",
            'patientDetail.saveDraft': 'Save as draft (not visible to the patient)',
            'patientDetail.sharedBadge': 'Shared with patient',
            'patientDetail.saveNote': 'Save Record',
            'patientDetail.prescriptions': 'Prescriptions',
            'patientDetail.noAppointments': 'No appointment history yet',
            'patientDetail.noNotes': 'No medical records yet',
            ...
            'patientDetail.noteSavedTitle': 'Record saved',
            'patientDetail.noteSavedHint': "The medical record was added to the patient's file.",
            'patientDetail.noteErrorTitle': "Couldn't save the record",
            ...
            'patientDetail.editLoadError': "Couldn't load this record for editing",
            'patientDetail.saveChanges': 'Save Changes',
            'patientDetail.cancelEdit': 'Cancel',
            'patientDetail.editSuccess': 'Record updated',
            'patientDetail.editError': "Couldn't save the changes",
            'patientDetail.deleteModalTitle': 'Delete Medical Record',
            'patientDetail.deleteModalHint': "Are you sure you want to delete this record? This can't be undone.",
            'patientDetail.deleteDismiss': 'Cancel',
