...
const I18n = (() => {
    const dict = {
        ar: {
            ...
            'doctor.postsPreviewCaption': 'معاينة لما ستراه هنا عند توفر هذه الميزة',
            ...
            'feedback.notConnectedTitle': 'لم يتم حفظ ملاحظاتك بعد',
            'feedback.notConnectedHint': 'نموذج الملاحظات هذا غير متصل بأي خادم بعد، لذلك لم يتم حفظ إجاباتك في أي مكان. نعمل على إضافة هذه الميزة قريباً.',
            ...
            'doctorPosts.notConnectedTitle': 'لم يتم حفظ المنشور بعد',
            'doctorPosts.notConnectedHint': 'إدارة المنشورات غير متصلة بأي خادم بعد، لذلك لم يتم حفظ منشورك في أي مكان. نعمل على إضافة هذه الميزة قريباً.',
            'doctorPosts.emptyTitle': 'لا توجد منشورات بعد',
            'doctorPosts.emptyHint': 'هذه الميزة غير متصلة بخادم بعد، لذلك لا يمكن حفظ أو عرض منشوراتك الفعلية حالياً.',
            ...
            // My Patients (doctor's patient list — no backend yet)
            ...
            'myPatients.emptyTitle': 'هذه الميزة غير متاحة بعد',
            'myPatients.emptyHint': 'نعمل على ربط قائمة مرضاك بحسابك. بمجرد توفر هذه الميزة، سيظهر مرضاك هنا تلقائياً.',
            ...
            'patientDetail.emptyTitle': 'هذه الميزة غير متاحة بعد',
            'patientDetail.emptyHint': 'نعمل على ربط ملفات المرضى بحسابك. بمجرد توفر هذه الميزة، سيظهر السجل الكامل هنا تلقائياً.',
            'patientDetail.noteNotConnectedTitle': 'لم يتم حفظ الملاحظة بعد',
            'patientDetail.noteNotConnectedHint': 'هذه الميزة غير متصلة بأي خادم بعد، لذلك لم يتم حفظ ملاحظتك في أي مكان. نعمل على إضافة هذه الميزة قريباً.',
            ...
            'myDoctor.emptyTitle': 'هذه الميزة غير متاحة بعد',
            'myDoctor.emptyHint': 'نعمل على ربط بيانات طبيبك المعالج بحسابك. بمجرد توفر هذه الميزة، ستظهر هنا تلقائياً.',
        ...
        en: {
            ...
            'doctor.posts': 'Posts',
            'doctor.postsPreviewCaption': "Preview of what you'll see here once this feature is available",
            ...
            'feedback.notConnectedTitle': "Your feedback wasn't saved yet",
            'feedback.notConnectedHint': "This feedback form isn't connected to a server yet, so your answers weren't saved anywhere. We're working on adding this feature soon.",
            ...
            'doctorPosts.notConnectedTitle': "Your post wasn't saved yet",
            'doctorPosts.notConnectedHint': "Post management isn't connected to a server yet, so your post wasn't saved anywhere. We're working on adding this feature soon.",
            'doctorPosts.emptyTitle': 'No posts yet',
            'doctorPosts.emptyHint': "This feature isn't connected to a server yet, so your real posts can't be saved or shown right now.",
            ...
            'myPatients.emptyTitle': "This feature isn't available yet",
            'myPatients.emptyHint': "We're working on connecting your patient list to your account. Once this feature is live, your patients will show up here automatically.",
            ...
            'patientDetail.emptyTitle': "This feature isn't available yet",
            'patientDetail.emptyHint': "We're working on connecting patient files to your account. Once this feature is live, the full record will show up here automatically.",
            'patientDetail.noteNotConnectedTitle': "Your note wasn't saved yet",
            'patientDetail.noteNotConnectedHint': "This feature isn't connected to a server yet, so your note wasn't saved anywhere. We're working on adding this feature soon.",
            ...
            'myDoctor.emptyTitle': "This feature isn't available yet",
            'myDoctor.emptyHint': "We're working on connecting your treating doctor's data to your account. Once this feature is live, it will show up here automatically.",
