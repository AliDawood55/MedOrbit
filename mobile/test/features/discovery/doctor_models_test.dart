...
void main() {
  test(
    'parses doctor list with numeric strings nested clinics availability and reviews',
    () {
          ...
          'doctors': [
            {
              ...
              'professional_bio': 'طبيب قلب / Cardiologist',
      ...
      expect(doctor.professionalBio, 'طبيب قلب / Cardiologist');
  ...
  test(
    'parses doctor detail and availability response with camelCase aliases',
    () {
  ...
  test(
    'missing optional fields do not throw and toJson copies unknown maps',
    () {
      expect(
