...
class _RegisterScreenState extends ConsumerState<RegisterScreen> {
  ...
  Future<void> _submit() async {
    ...
    if (success) {
      ...
      context.go(Uri(path: RoutePaths.verifyCode, queryParameters: {'email': normalizedEmail}).toString());
    }
  }
  ...
  Widget _namePair({
    ...
    final firstField = AppTextField(
      ...
      prefixIcon: const Icon(Icons.person_outline_rounded, size: AppTheme.iconMd),
  ...
  Widget build(BuildContext context) {
    ...
    return AuthPageFrame(
      ...
      body: Column(
        ...
        children: [
          SectionHeader(title: strings.personalDetailsSection, subtitle: strings.registerSubtitle),
          Card(
            child: Padding(
                  ...
                  child: LayoutBuilder(
                    builder: (context, constraints) {
                      ...
                      return Column(
                        ...
                        const SizedBox(height: AppTheme.spaceMd),
                        SectionHeader(title: strings.contactSection, padding: const EdgeInsets.only(bottom: AppTheme.spaceSm)),
                        AppTextField(
                        ...
                        AppTextField(
                          ...
                          textInputAction: TextInputAction.next,
                          textDirection: TextDirection.ltr,
                          prefixIcon: const Icon(Icons.phone_outlined, size: AppTheme.iconMd),
                        ),
                        const SizedBox(height: AppTheme.spaceMd),
                        SectionHeader(title: strings.securitySection, padding: const EdgeInsets.only(bottom: AppTheme.spaceSm)),
                        RadioGroup<String>(
                          groupValue: _gender,
                        ...
                        CheckboxListTile(
                          ...
                          title: Text(strings.termsAgreement, style: Theme.of(context).textTheme.bodyMedium),
                        ...
                        GoogleSignInButton(
                          ...
                          isLoading: authState.isSubmitting,
                          onPressed: authState.isSubmitting ? null : _submitWithGoogle,
                        ),
                        ],
                      );
                    },
