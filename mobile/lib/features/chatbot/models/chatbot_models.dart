...
class ChatMessageRequest {
  ...
  factory ChatMessageRequest.fromJson(Map<String, dynamic> json) {
    return ChatMessageRequest(
      ...
      conversationId: _asString(
        _read(json, 'conversation_id', 'conversationId'),
      ),
      latitude: _asDouble(json['latitude']),
      longitude: _asDouble(json['longitude']),
      clientMessageId: _asString(
        _read(json, 'client_message_id', 'request_id'),
      ),
...
class ChatMessageResponse {
  ...
  factory ChatMessageResponse.fromJson(Map<String, dynamic> json) {
    ...
    return ChatMessageResponse(
      conversationId:
          _asString(_read(data, 'conversation_id', 'conversationId')) ?? '',
      ...
      route: _asMap(data['route']) == null
          ? null
          : ChatRouteResult.fromJson(_asMap(data['route'])!),
      suggestions: _rawList(
        data['suggestions'],
      ).map(ChatSuggestion.fromValue).toList(),
      quota: _asMap(data['quota']) == null
          ? null
          : ChatEntitlement.fromQuotaJson(_asMap(data['quota'])!),
...
class ConversationSummary {
  ...
  factory ConversationSummary.fromJson(Map<String, dynamic> json) {
    return ConversationSummary(
      ...
      isAutoGenerated: _asBool(
        _read(json, 'is_auto_generated', 'isAutoGenerated'),
      ),
  ...
  factory ConversationDetail.fromJson(Map<String, dynamic> json) {
    ...
    return ConversationDetail(
      conversation: conversation == null
          ? null
          : ConversationSummary.fromJson(conversation),
      messages: _list(data['messages']).map(ChatMessage.fromJson).toList(),
      places: _list(
        data['places'],
      ).map(ChatConversationPlace.fromJson).toList(),
...
class ChatMessage {
  ...
  factory ChatMessage.fromJson(Map<String, dynamic> json) {
    return ChatMessage(
      ...
      messageText:
          _asString(_read(json, 'message_text', 'messageText')) ??
          _asString(json['message']) ??
          '',
      messageType: _asString(_read(json, 'message_type', 'messageType')) ?? '',
      confidenceScore: _asDouble(
        _read(json, 'confidence_score', 'confidenceScore'),
      ),
      metadata: ChatMetadata.fromJson(_asMap(json['metadata']) ?? const {}),
      createdAt: _asDate(_read(json, 'created_at', 'createdAt')),
      entities: _asMap(json['entities']) ?? const {},
      conversationContext:
          _asMap(_read(json, 'conversation_context', 'conversationContext')) ??
          const {},
      lastIntent: _asString(_read(json, 'last_intent', 'lastIntent')),
      hasLocation: _asBool(_read(json, 'has_location', 'hasLocation')),
      extra: _extra(json, const {
  ...
  factory ChatRouteResult.fromJson(Map<String, dynamic> json) {
    return ChatRouteResult(
      ...
      durationMinutes: _asInt(
        _read(json, 'duration_minutes', 'durationMinutes'),
      ),
...
List<Object?> _rawList(Object? value) =>
