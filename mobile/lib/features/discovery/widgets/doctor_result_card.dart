  ...
  Widget build(BuildContext context) {
    ...
    final values = <Widget>[
      ...
      if (doctor.yearsOfExperience != null)
        Directionality(textDirection: TextDirection.ltr, child: _Fact(icon: Icons.work_outline_rounded, value: '${doctor.yearsOfExperience} years')),
      ...
      if (doctor.consultationFee != null)
        Directionality(textDirection: TextDirection.ltr, child: _Fact(icon: Icons.payments_outlined, value: '${doctor.consultationFee!.toStringAsFixed(0)} ILS')),
      if (doctor.consultationDuration != null)
        Directionality(textDirection: TextDirection.ltr, child: _Fact(icon: Icons.schedule_outlined, value: '${doctor.consultationDuration} min')),
    ];
          ...
          child: Column(
            ...
            children: [
              Wrap(
                ...
                children: [
                  StatusBadge(
                    label: doctor.isAcceptingPatients == true ? 'Accepting patients' : 'Availability not confirmed',
              ...
              if (clinic != null) ...[
                const SizedBox(height: AppTheme.spaceSm),
                _Fact(icon: Icons.local_hospital_outlined, value: clinicDisplayName(clinic, direction)),
              ],
              const SizedBox(height: AppTheme.spaceSm),
              Align(
...
String doctorDisplayName(Doctor doctor, TextDirection direction) {
...
String clinicDisplayName(DoctorClinicSummary clinic, TextDirection direction) {
  final value = direction == TextDirection.rtl ? clinic.nameAr ?? clinic.nameEn : clinic.nameEn ?? clinic.nameAr;
  return value?.trim().isNotEmpty == true ? value!.trim() : 'Clinic';
}
