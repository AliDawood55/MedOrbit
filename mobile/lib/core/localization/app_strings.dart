...
class AppStrings {
  ...
  String get errorGeneric => _t('حدث خطأ ما. حاول مرة أخرى.', 'Something went wrong. Please try again.');
  ...
  String get chatErrTitle => _t('تعذّر إرسال الرسالة', 'Could not send message');
  ...
  // Auth
  String get welcomeTitle => _t('مرحبًا بك في ميد أوربت', 'Welcome to MedOrbit');
  String get signInSubtitle => _t('سجّل الدخول للمتابعة', 'Sign in to continue');
  String get emailLabel => _t('البريد الإلكتروني', 'Email');
  String get emailPlaceholder => _t('example@medorbit.com', 'example@medorbit.com');
  String get emailRequired => _t('البريد الإلكتروني مطلوب.', 'Email is required.');
  String get invalidEmail => _t('أدخل بريدًا إلكترونيًا صالحًا.', 'Enter a valid email address.');
  String requiredField(String label) => _t('$label مطلوب.', '$label is required.');
  String get passwordLabel => _t('كلمة المرور', 'Password');
  String get passwordPlaceholder => _t('أدخل كلمة المرور', 'Enter your password');
  String get logIn => _t('تسجيل الدخول', 'Log In');
  String get orDivider => _t('أو', 'OR');
  String get continueWithGoogle => _t('المتابعة باستخدام جوجل', 'Continue with Google');
  String get noAccountCta => _t('ليس لديك حساب؟ إنشاء حساب', "Don't have an account? Register");
  String get haveAccountCta => _t('لديك حساب؟ تسجيل الدخول', 'Already have an account? Log in');
  String get createAccountTitle => _t('إنشاء حساب', 'Create Account');
  String get personalDetailsSection => _t('البيانات الشخصية', 'Personal Details');
  ...
  String get firstNameEnLabel => _t('الاسم الأول (إنجليزي)', 'First Name (English)');
  String get lastNameEnLabel => _t('اسم العائلة (إنجليزي)', 'Last Name (English)');
  String get firstNameArLabel => _t('الاسم الأول (عربي)', 'First Name (Arabic)');
  String get lastNameArLabel => _t('اسم العائلة (عربي)', 'Last Name (Arabic)');
  String get phoneOptionalLabel => _t('رقم الهاتف (اختياري)', 'Phone (optional)');
  String get maleLabel => _t('ذكر', 'Male');
  String get femaleLabel => _t('أنثى', 'Female');
  String get registerButton => _t('إنشاء حساب', 'Register');
  String get registrationStepOne => _t('الخطوة 1 من 2: بيانات الحساب', 'Step 1 of 2: Account details');
  String get verificationStepTwo => _t('الخطوة 2 من 2: تأكيد البريد', 'Step 2 of 2: Email verification');
  String get continueToVerification => _t('المتابعة إلى التحقق', 'Continue to verification');
  String get termsAgreement => _t(
        'أوافق على شروط الاستخدام وسياسة الخصوصية',
        'I agree to the Terms of Use and Privacy Policy',
      );
  String get termsRequired => _t('يجب الموافقة للمتابعة.', 'You must agree before continuing.');
  String get passwordRequired => _t('كلمة المرور مطلوبة.', 'Password is required.');
  String get confirmPasswordRequired => _t('أكد كلمة المرور.', 'Confirm your password.');
  ...
  String get registerSuccessMessage =>
      _t('تم إنشاء الحساب بنجاح. تحقق من بريدك الإلكتروني لتفعيله ثم سجّل الدخول.', 'Account created. Check your email to verify it, then log in.');
  String get registerSubtitle =>
      _t('أنشئ حسابك لإدارة المواعيد والوصفات والسجلات.', 'Create your account to manage appointments, prescriptions, and records.');
  String get verifyEmailHint => _t('إذا لم يصلك الرمز، يمكنك طلب إعادة الإرسال.', 'If you did not receive the code, you can request it again.');
  String get forgotPasswordTitle => _t('نسيت كلمة المرور؟', 'Forgot Password?');
  String get forgotPasswordSubtitle =>
      _t('أدخل بريدك الإلكتروني وسنرسل لك رابط إعادة التعيين.', 'Enter your email and we will send a reset link.');
  String get sendResetLinkButton => _t('إرسال رابط إعادة التعيين', 'Send Reset Link');
  String get resetLinkSentTitle => _t('تم إرسال الرابط', 'Reset link sent');
  String get resetLinkSentHint =>
      _t('إذا كان البريد مسجلاً، فسيصلك رابط إعادة التعيين.', 'If that email is registered, a reset link will be sent.');
  String get verifyCodeTitle => _t('تحقق من البريد الإلكتروني', 'Verify Email');
  String get verifyCodeSubtitle =>
      _t('أدخل رمز التحقق الموجود في البريد الإلكتروني.', 'Enter the verification code from your email.');
  String get codeSentTitle => _t('تحقق من صندوق الوارد', 'Check your inbox');
  String codeSentTo(String email) => _t('أرسلنا رمزًا من 6 أرقام إلى $email', 'We sent a 6-digit code to $email');
  String get enterEmailToVerify => _t('أدخل بريد الحساب لتأكيد الرمز.', 'Enter the account email to verify the code.');
  String get enterSixDigitCode => _t('أدخل الرمز المكون من 6 أرقام', 'Enter the 6-digit code');
  String otpDigitLabel(int position) => _t('رقم التحقق $position من 6', 'Verification digit $position of 6');
  String get otpIncomplete => _t('أدخل الأرقام الستة.', 'Enter all six digits.');
  String get verifyingEmail => _t('جارٍ التحقق من البريد الإلكتروني', 'Verifying email');
  ...
  String get verifySuccessTitle => _t('تم التحقق من البريد الإلكتروني', 'Email verified');
  String get verifySuccessHint =>
      _t('أصبح حسابك جاهزًا. يمكنك تسجيل الدخول الآن.', 'Your account is ready. You can log in now.');
  String get verifyCodeMissing =>
      _t('أدخل رمز التحقق أو افتح الرابط من البريد الإلكتروني.', 'Enter the verification code or open the link from your email.');
  String get resendVerificationTitle => _t('لم يصلك الرمز؟', 'Did not receive the code?');
  String get resendVerificationHint =>
      _t('يمكنك طلب رمز جديد بعد انتهاء العد التنازلي.', 'You can request a new code when the countdown ends.');
  String get resendVerificationButton => _t('إعادة إرسال الرمز', 'Resend code');
  String resendIn(int seconds) => _t('إعادة الإرسال خلال $seconds ث', 'Resend in ${seconds}s');
  String get resendSuccess => _t('تم إرسال رمز جديد إذا كان الحساب مؤهلًا.', 'A new code was sent if the account is eligible.');
  String get invalidVerificationCode => _t('رمز التحقق غير صحيح. حاول مرة أخرى.', 'That verification code is incorrect. Try again.');
  String get expiredVerificationCode => _t('انتهت صلاحية الرمز. اطلب رمزًا جديدًا.', 'That code has expired. Request a new one.');
  String get usedVerificationCode => _t('تم استخدام هذا الرمز من قبل. حاول تسجيل الدخول.', 'That code was already used. Try logging in.');
  String get verificationRateLimited => _t('محاولات كثيرة. انتظر قليلًا ثم حاول مجددًا.', 'Too many attempts. Wait a while and try again.');
  String get verificationValidationError => _t('تحقق من البريد والرمز ثم حاول مجددًا.', 'Check the email and code, then try again.');
  String get resetPasswordTitle => _t('إعادة تعيين كلمة المرور', 'Reset Password');
  String get resetPasswordSubtitle => _t('أدخل كلمة مرور جديدة لحسابك.', 'Enter a new password for your account.');
  String get resetTokenLabel => _t('رمز/رابط التحقق', 'Reset Token / Code');
  String get resetTokenPlaceholder => _t('أدخل الرمز من البريد الإلكتروني', 'Enter the code from your email');
  String get newPasswordLabel => _t('كلمة المرور الجديدة', 'New Password');
  String get newPasswordPlaceholder => _t('أدخل كلمة المرور الجديدة', 'Enter your new password');
  String get confirmPasswordLabel => _t('تأكيد كلمة المرور', 'Confirm Password');
  String get confirmPasswordPlaceholder => _t('أعد إدخال كلمة المرور', 'Re-enter your password');
  String get resetPasswordButton => _t('تعيين كلمة المرور الجديدة', 'Set New Password');
  String get resetPasswordSuccessTitle => _t('تم تحديث كلمة المرور', 'Password updated');
  String get resetPasswordSuccessHint => _t('يمكنك تسجيل الدخول الآن.', 'You can log in now.');
  String get passwordMismatch => _t('كلمتا المرور غير متطابقتين', 'Passwords do not match');
  ...
  String get patientDashboardSubtitle =>
      _t('إليك نظرة سريعة على صحتك ورعايتك.', 'Here is a quick look at your health and care.');
  String get doctorDashboardSubtitle =>
      _t('إليك نظرة سريعة على حسابك المهني.', 'Here is a quick look at your professional account.');
  String get adminDashboardSubtitle =>
      _t('إليك نظرة سريعة على حساب الإدارة.', 'Here is a quick look at your administration account.');
  String get profileLoadErrorTitle => _t('تعذر تحميل ملفك الشخصي', 'Could not load your profile');
  String get profileLoadErrorMessage =>
      _t('تحقق من الاتصال ثم أعد المحاولة.', 'Check your connection and try again.');
  String get loadingProfile => _t('جارٍ تحميل ملفك الشخصي...', 'Loading your profile...');
  ...
  String get dashboardStatisticsSubtitle =>
      _t('ملخص مباشر لبياناتك الصحية المتاحة.', 'A live summary of your available health data.');
  String get upcomingAppointmentsStat => _t('مواعيد قادمة', 'Upcoming appointments');
  String get prescriptionsStat => _t('وصفات طبية', 'Prescriptions');
  String get medicalRecordsStat => _t('سجلات طبية', 'Medical records');
  String get statLoadError => _t('تعذر تحميل العدد. اضغط لإعادة المحاولة.', 'Count unavailable. Tap to retry.');
  String get quickActionsTitle => _t('إجراءات سريعة', 'Quick Actions');
  String get quickActionsSubtitle =>
      _t('ابحث أو انتقل إلى الخدمات المتاحة.', 'Search or open an available service.');
  String get dashboardSearchLabel => _t('البحث في الإجراءات السريعة', 'Search quick actions');
  String get dashboardSearchPlaceholder =>
      _t('ابحث في لوحة التحكم...', 'Search the dashboard...');
  String get dashboardSearchNoResults => _t('لا توجد نتائج مطابقة', 'No matching actions');
  ...
  String get quickAppointmentsDescription =>
      _t('راجع مواعيدك وحالاتها.', 'Review your appointments and their status.');
  String get quickBookAppointmentDescription =>
      _t('احجز موعدًا جديدًا مع طبيبك المفضل.', 'Book a new appointment with your doctor.');
  ...
  String get upcomingAppointmentsTitle => _t('المواعيد القادمة', 'Upcoming Appointments');
  String get recentPrescriptionsTitle => _t('أحدث الوصفات الطبية', 'Recent Prescriptions');
  String get recentMedicalRecordsTitle => _t('أحدث السجلات الطبية', 'Recent Medical Records');
  String get loadingAppointments => _t('جارٍ تحميل المواعيد...', 'Loading appointments...');
  String get loadingPrescriptions => _t('جارٍ تحميل الوصفات...', 'Loading prescriptions...');
  String get loadingMedicalRecords => _t('جارٍ تحميل السجلات...', 'Loading medical records...');
  ...
  String get noUpcomingAppointments => _t('لا توجد مواعيد قادمة', 'No upcoming appointments');
  String get noUpcomingAppointmentsHint =>
      _t('يمكنك مراجعة جميع مواعيدك من صفحة المواعيد.', 'Review all your appointments on the appointments page.');
  String get appointmentsLoadErrorTitle => _t('تعذر تحميل المواعيد', 'Could not load appointments');
  String get appointmentsLoadErrorMessage =>
      _t('تحقق من الاتصال ثم أعد المحاولة.', 'Check your connection and try again.');
  ...
  String get recordSearchLabel => _t('البحث في السجلات', 'Search medical records');
  ...
  String get medicalTimelineTitle => _t('السجل الزمني الطبي', 'Medical timeline');
  ...
  String get medicalAppointmentFallback => _t('موعد طبي', 'Medical appointment');
  ...
  String get recordsEmptyHint =>
      _t('ستظهر مواعيدك وسجلاتك ووصفاتك الطبية هنا.', 'Your appointments, records, and prescriptions will appear here.');
  ...
  String get detailPrescriptionNumber => _t('رقم الوصفة', 'Prescription Number');
  ...
  String get prescriptionDateFilterLabel =>
      _t('تاريخ الإصدار', 'Issued date');
  String get filterAllPrescriptions =>
      _t('كل الوصفات', 'All prescriptions');
  ...
  String get prescriptionsEmptyTitle => _t('لا توجد وصفات طبية بعد', 'No prescriptions yet');
  String get prescriptionsEmptyHint =>
      _t('ستظهر الوصفات الطبية التي يصفها طبيبك هنا.', "Prescriptions written by your doctor will appear here.");
  ...
  String medicationCount(int count) =>
      _t('$count دواء', '$count medications');
  String get viewPrescriptionDetails =>
      _t('عرض التفاصيل', 'View details');
  String get prescriptionFallbackTitle =>
      _t('وصفة طبية', 'Prescription');
  ...
  String get emptyUpcoming => _t('لا توجد مواعيد قادمة', 'No upcoming appointments');
  ...
  String get emptyCancelledTab => _t('لا توجد مواعيد ملغاة', 'No cancelled appointments');
  String get emptyCancelledHint => _t(
        'لا توجد مواعيد ملغاة في حسابك.',
        'There are no cancelled appointments in your account.',
      );
  String get cancelAppointmentAction => _t('إلغاء الموعد', 'Cancel Appointment');
  String get cancelDialogTitle => _t('إلغاء الموعد؟', 'Cancel this appointment?');
  String get cancelDialogBody =>
      _t('هل أنت متأكد من رغبتك في إلغاء هذا الموعد؟', 'Are you sure you want to cancel this appointment?');
  String get cancelReasonHint => _t('السبب (اختياري)', 'Reason (optional)');
  String get cancelReasonPlaceholder =>
      _t('اكتب سبب الإلغاء إن رغبت...', 'Add a cancellation reason if needed...');
  String get cancelConfirm => _t('تأكيد الإلغاء', 'Confirm Cancel');
  String get cancelSuccessMessage => _t('تم إلغاء الموعد', 'Appointment cancelled');
  String get cancelErrorMessage =>
      _t('تعذر إلغاء الموعد. حاول مرة أخرى.', 'Could not cancel the appointment. Try again.');
  ...
  String get searchDoctorsHint => _t('ابحث عن طبيب بالاسم...', 'Search for a doctor by name...');
  String get noDoctorsFound => _t('لم يتم العثور على أطباء مطابقين', 'No matching doctors found');
  String get couldNotLoadDoctors => _t('تعذر تحميل قائمة الأطباء', 'Could not load doctors');
  String get changeDoctorAction => _t('تغيير الطبيب', 'Change doctor');
  String get doctorNotFoundMessage => _t('الطبيب غير موجود', 'Doctor not found');
  String get doctorLoadErrorMessage => _t('تعذر تحميل بيانات الطبيب', "Could not load this doctor's data");
  ...
  String get noClinicsTitle => _t('لا توجد عيادات متاحة لهذا الطبيب', 'No clinics available for this doctor');
  String get noClinicsHint => _t('لا يمكن حجز موعد مع هذا الطبيب حاليًا', 'This doctor cannot be booked right now');
  String get noSlotsTitle => _t('لا توجد أوقات متاحة', 'No available times');
  String get noSlotsHint => _t('جرّب اختيار تاريخ آخر أو عيادة أخرى', 'Try a different date or clinic');
  String get couldNotLoadSlots => _t('تعذر تحميل الأوقات المتاحة', 'Could not load available times');
  ...
  String get bookingSuccessTitle => _t('تم حجز موعدك بنجاح', 'Your appointment is booked');
  String get bookingSuccessHint => _t('رقم الموعد الخاص بك:', 'Your appointment number:');
  String get viewMyAppointmentsAction => _t('عرض مواعيدي', 'View my appointments');
  String get bookAnotherAppointmentAction => _t('حجز موعد آخر', 'Book another appointment');
  String get slotBusyMessage =>
      _t('تم حجز هذا الوقت للتو من مستخدم آخر، الرجاء اختيار وقت مختلف', 'This time slot was just booked by someone else — please pick a different time');
  String get patientNotFoundMessage =>
      _t('تعذر إيجاد ملفك الطبي. الرجاء التواصل مع الدعم الفني', 'We could not find your patient profile. Please contact support');
  String get bookingTimeoutMessage =>
      _t('استغرق الحجز وقتًا أطول من المتوقع. حاول مرة أخرى.', 'Booking took longer than expected. Please try again.');
  String get bookingServiceUnavailableMessage => _t(
        'تعذّر الوصول إلى الخدمة. تحقّق من اتصالك ثم أعد المحاولة.',
        'Could not reach the service. Check your connection and try again.',
      );
  String get couldNotCreateAppointment => _t('تعذر إتمام الحجز، الرجاء المحاولة مرة أخرى', 'Could not complete the booking, please try again');
  ...
  String get notificationsSubtitle => _t('كل إشعاراتك في مكان واحد', 'All your notifications in one place');
  String get notificationsFilterAll => _t('الكل', 'All');
  String get notificationsFilterUnread => _t('غير مقروءة', 'Unread');
  String get notificationsMarkAllRead => _t('تعليم الكل كمقروء', 'Mark all read');
  String get notificationsMarkRead => _t('تعليم كمقروء', 'Mark as read');
  String get notificationsDeleteOne => _t('حذف', 'Delete');
  String get notificationsDeleteDialogTitle => _t('حذف الإشعار؟', 'Delete this notification?');
  String get notificationsDeleteDialogBody =>
      _t('لا يمكن التراجع عن هذا الإجراء.', 'This action cannot be undone.');
  String get notificationsErrorLoad => _t('تعذر تحميل الإشعارات', 'Could not load your notifications');
  String get notificationsMarkReadError => _t('تعذر تحديث الإشعار', 'Could not update the notification');
  String get notificationsMarkAllError => _t('تعذر تحديث الإشعارات', 'Could not update notifications');
  String get notificationsDeleteError => _t('تعذر حذف الإشعار', 'Could not delete the notification');
  String get notificationsEmptyTitle => _t('لا توجد إشعارات', 'No notifications');
  String get notificationsEmptyHint =>
      _t('ستظهر إشعاراتك هنا عند وصولها', 'Your notifications will show up here when they arrive');
  String get notificationsEmptyUnreadTitle => _t('لا توجد إشعارات غير مقروءة', 'No unread notifications');
  String get notificationsEmptyUnreadHint =>
      _t('أحسنت! لقد اطلعت على كل شيء', "Nice — you're all caught up");
  String get quickNotificationsDescription => _t('عرض كل إشعاراتك', 'View all your notifications');
  String notificationsUnreadCountDescription(int count) =>
      _t('$count إشعار غير مقروء', '$count unread notification${count == 1 ? '' : 's'}');
  ...
  String notificationsMinutesAgo(int minutes) => _t('منذ $minutes د', '${minutes}m ago');
  String notificationsHoursAgo(int hours) => _t('منذ $hours س', '${hours}h ago');
  ...
  String get profileSubtitle =>
      _t('إدارة معلوماتك الشخصية وإعدادات حسابك', 'Manage your personal information and account settings');
  String get quickProfileDescription =>
      _t('عدّل بياناتك الشخصية وإعدادات حسابك.', 'Edit your personal details and account settings.');
  String get profileLoadError => _t('تعذر تحميل بيانات حسابك', 'Could not load your account data');
  String profileMemberSince(String date) => _t('عضو منذ $date', 'Member since $date');

  String get changePhotoAction => _t('تغيير الصورة', 'Change photo');
  String get avatarHint => _t('JPG أو PNG — حتى 2 ميجابايت', 'JPG or PNG — up to 2MB');
  String get avatarErrorInvalidType =>
      _t('صيغة الصورة غير مدعومة. استخدم JPG أو PNG.', 'Unsupported image format. Use JPG or PNG.');
  String get avatarErrorTooLarge =>
      _t('حجم الصورة كبير جدًا. الحد الأقصى 2 ميجابايت.', 'The image is too large. Maximum size is 2MB.');
  String get avatarErrorGeneric =>
      _t('تعذر رفع الصورة. تأكد أن حجمها أقل من 2 ميجابايت.', 'Could not upload the photo. Make sure it is under 2MB.');

  String get profileSectionInfo => _t('المعلومات الشخصية', 'Personal Information');
  String get addressLabel => _t('العنوان', 'Address');
  String get addressPlaceholder => _t('الحي، الشارع...', 'Neighborhood, street...');
  ...
  String get profileSaveSuccess => _t('تم حفظ التغييرات بنجاح', 'Changes saved successfully');
  String get profileSaveError => _t('تعذر حفظ التغييرات، حاول مرة أخرى', 'Could not save changes, please try again');
  String get profileSaveTimeout =>
      _t('استغرق الحفظ وقتًا أطول من المتوقع. حاول مرة أخرى.', 'Saving took longer than expected. Please try again.');
  ...
  String get profileLanguageDesc =>
      _t('تُطبَّق فوراً وتُحفظ لحسابك', 'Applied immediately and saved to your account');
  String get profileLanguageArOption => _t('العربية', 'العربية');
  String get profileLanguageEnOption => _t('English', 'English');
  String get profileLanguageSyncError =>
      _t('تم تغيير اللغة، لكن تعذر حفظها في حسابك.', 'Language changed, but could not be saved to your account.');

  String get profileSectionTheme => _t('المظهر', 'Appearance');
  String get profileThemeDesc => _t('يُحفظ على هذا الجهاز فقط', 'Saved on this device only');
  ...
  String get profileSectionPassword => _t('تغيير كلمة المرور', 'Change Password');
  ...
  String get currentPasswordLabel => _t('كلمة المرور الحالية', 'Current password');
  ...
  String get wrongCurrentPasswordError => _t('كلمة المرور الحالية غير صحيحة', 'Current password is incorrect');
  ...
  String get categoryClinics =>
      _t('سهولة إيجاد العيادات', 'Finding clinics');
  String get categoryBooking =>
      _t('سهولة حجز المواعيد', 'Appointment booking');
  ...
  String get commentHelper => _t(
        'بحد أقصى 500 حرف.',
        'Up to 500 characters.',
      );
  String get feedbackSubmissionTitle => _t('إرسال الملاحظات', 'Submit feedback');
  ...
  String get submittingFeedback => _t('جارٍ إرسال الملاحظات...', 'Submitting feedback...');
  String get feedbackSuccessTitle => _t('شكرًا لملاحظاتك!', 'Thank you for your feedback!');
  String get feedbackSuccessHint => _t('تم إرسال ملاحظاتك بنجاح.', 'Your feedback has been submitted successfully.');
  String get errorRatingRequired => _t('يرجى اختيار التقييم العام', 'Please select an overall rating');
  String get feedbackErrorTitle => _t('تعذر إرسال الملاحظات', 'Failed to submit feedback');
  ...
  String get virtualDoctorTagline =>
      _t('تحدّث بشكل طبيعي — الطبيب يستمع ويجيب.', 'Speak naturally — the doctor listens and replies.');
  ...
  String get vdNoMessages => _t('تبدأ المحادثة بعد الاتصال.', 'The conversation begins after connecting.');
  String get vdConsultationStatus => _t('حالة الاستشارة', 'Consultation status');
  String get vdElapsedTime => _t('المدة المنقضية', 'Elapsed time');
  String get vdConsultationProgress => _t('مرحلة الاستشارة', 'Consultation phase');
  ...
  String get vdGeneratingReport => _t('جارٍ إنشاء التقرير...', 'Generating report...');
  ...
  String get vdSessionErrorTitle => _t('تعذّر بدء الاستشارة', 'Could not start consultation');
  String get vdDismissError => _t('إخفاء الخطأ', 'Dismiss error');
  String vdVoiceState(String state) => _t('حالة الطبيب الصوتية: $state', 'Voice doctor status: $state');
  String vdElapsedValue(String value) => _t('المدة المنقضية $value', 'Elapsed time $value');
  String get vdStateIdle => _t('جاهز', 'Ready');
  String get vdStateConnecting => _t('جارٍ الاتصال...', 'Connecting...');
  String get vdStateListening => _t('اضغط على الميكروفون للتحدث', 'Tap the mic to speak');
  String get vdStateRecording => _t('أستمع إليك... اضغط عند الانتهاء', "Listening... tap when you're done");
  String get vdStateTranscribing => _t('جارٍ تحويل الكلام...', 'Transcribing...');
  String get vdStateThinking => _t('الطبيب يفكر...', 'The doctor is thinking...');
  String get vdStateSpeaking => _t('الطبيب يتحدث...', 'The doctor is speaking...');
  ...
  String get vdThinkingHint =>
      _t('قد يستغرق التحليل النهائي حتى دقيقة.', 'The final analysis can take up to a minute.');
  String get vdEmergencyTitle => _t('حالة طارئة', 'Emergency');
  String get vdDownloadReport => _t('تحميل التقرير (PDF)', 'Download Report (PDF)');
  String get vdOpenReport => _t('فتح التقرير', 'Open Report');
  String get vdReportSaved => _t('تم حفظ التقرير', 'Report saved');
  String get vdReportUnavailable =>
      _t('خدمة التقارير غير متاحة مؤقتًا. الملخص أعلاه ما زال صالحًا.',
          'The report service is temporarily unavailable. The summary above still stands.');
  String get vdRecommendedSpecialty => _t('التخصص الموصى به', 'Recommended Specialty');
  String get vdMicDenied => _t('لم يتم السماح بالوصول إلى الميكروفون', 'Microphone permission denied');
  String get vdMicDeniedHint =>
      _t('الاستشارة الصوتية تحتاج إلى الميكروفون. يمكنك السماح بذلك من إعدادات التطبيق.',
  ...
  String get vdErrNoSpeech => _t('لم أسمع شيئًا. حاول مرة أخرى.', "I didn't catch that. Please try again.");
  String get vdErrSttTimeout => _t('استغرق التحويل وقتًا طويلاً. أعد المحاولة.', 'Transcription timed out. Please try again.');
  String get vdErrConnect => _t('تعذر الاتصال بخدمة الطبيب الافتراضي.', 'Could not reach the Virtual Doctor service.');
  ...
  String get symptomCheckerGenericError =>
      _t('حدث خطأ غير متوقع. حاول مرة أخرى.', 'Something went wrong. Please try again.');
  String get symptomEmergencyTitle => _t('حالة طارئة محتملة', 'Possible emergency');
  ...
  String get drugCheckerErrorMinMeds => _t(
        'يرجى إضافة دواءين على الأقل',
        'Please add at least 2 medications',
      );
  ...
  String get drugCheckerGenericError =>
      _t('حدث خطأ غير متوقع. حاول مرة أخرى.', 'Something went wrong. Please try again.');
  ...
  String get drugCheckAnotherAction => _t('فحص أدوية أخرى', 'Check other medications');
  ...
  String get reportSummaryGenericError =>
      _t('حدث خطأ غير متوقع. حاول مرة أخرى.', 'Something went wrong. Please try again.');
  ...
  String get uploadReportFile => _t('رفع تقرير PDF أو صورة', 'Upload PDF/Image Report');
  ...
  String get quickMyReportsDescription =>
      _t('استعرض تقاريرك وملخصاتها السابقة.', 'Browse your past reports and summaries.');
  ...
  String get myReportsLoadError => _t('تعذّر تحميل التقارير', 'Could not load reports');
  ...
  String get discoveryApplyFiltersButton => _t('تطبيق التصفية', 'Apply filters');
  ...
  String get discoveryNoActiveFilters => _t('لا توجد عوامل تصفية نشطة', 'No active filters');
  String get discoverySearchActiveLabel => _t('البحث مفعّل', 'Search active');
  String discoveryFilterSummarySpecialty(String value) => _t('التخصص: $value', 'Specialty: $value');
  String discoveryFilterSummaryRegion(String value) => _t('المنطقة: $value', 'Region: $value');
  String discoveryFilterSummaryMinRating(String value) => _t('تقييم $value فأكثر', 'Rating $value+');
  String get discoveryFilterSummaryFeeActive => _t('عامل تصفية الرسوم مفعّل', 'Fee filter active');
  String discoveryFilterSummaryTypeValue(String label) => _t('النوع: $label', 'Type: $label');
  String discoveryFilterSummaryService(String value) => _t('الخدمة: $value', 'Service: $value');
  String discoveryFilterSummaryInsurance(String value) => _t('التأمين: $value', 'Insurance: $value');
  String get discoveryFilterSummaryNearby => _t('قريب', 'Nearby');
  String consultationFeeValue(String fee) => _t('$fee شيكل', '$fee ILS');
  String consultationDurationValue(int minutes) => _t('$minutes د', '$minutes min');
  String yearsExperienceValue(int years) => _t('$years سنة', '$years years');

  // Discovery — doctor directory
  String get doctorDirectoryScreenTitle => _t('دليل الأطباء', 'Doctor directory');
  ...
  String get searchDoctorsFieldHint => _t('الاسم أو التخصص', 'Name or specialty');
  String get doctorFilterSpecialtyLabel => _t('التخصص', 'Specialty');
  String get doctorFilterRegionLabel => _t('المنطقة', 'Region');
  String get doctorFilterMinRatingLabel => _t('الحد الأدنى للتقييم', 'Minimum rating');
  ...
  String get doctorFilterFeeRangeError =>
      _t('يجب أن يكون الحد الأقصى أكبر من أو يساوي الحد الأدنى', 'Maximum must be at least minimum');
  String get doctorFilterSheetTitle => _t('تصفية الأطباء', 'Filter doctors');
  String doctorResultsCount(int count) => _t('$count نتيجة طبيب', '$count doctor result${count == 1 ? '' : 's'}');
  String get doctorLoadingDoctors => _t('جارٍ تحميل الأطباء...', 'Loading doctors...');
  String get doctorEmptyTitle => _t('لم يتم العثور على أطباء', 'No doctors found');
  String get doctorEmptyHint =>
      _t('جرّب إزالة عوامل التصفية أو استخدام كلمة بحث مختلفة.', 'Try clearing filters or using a different search.');
  String get doctorAcceptingPatients => _t('يستقبل مرضى جدد', 'Accepting patients');
  String get doctorAvailabilityNotConfirmed => _t('التوفر غير مؤكد', 'Availability not confirmed');
  String get doctorNotAcceptingPatients => _t('لا يستقبل مرضى جدد', 'Not accepting patients');
  String get doctorFallbackName => _t('طبيب', 'Doctor');
  String get clinicFallbackName => _t('عيادة', 'Clinic');
  String get healthcareFacilityFallbackName => _t('منشأة صحية', 'Healthcare facility');

  // Discovery — doctor detail
  String get doctorDetailTitle => _t('تفاصيل الطبيب', 'Doctor details');
  String get doctorDetailLoadErrorTitle => _t('تعذر تحميل بيانات الطبيب', 'Could not load doctor');
  String get doctorDetailNotFoundTitle => _t('الطبيب غير موجود', 'Doctor not found');
  String get doctorDetailNotFoundHint =>
      _t('قد لا يكون هذا الطبيب متاحًا بعد الآن.', 'This doctor may no longer be available.');
  String get doctorLoadingDetails => _t('جارٍ تحميل بيانات الطبيب...', 'Loading doctor details...');
  ...
  String get doctorSectionProfessionalDetails => _t('التفاصيل المهنية', 'Professional details');
  String get doctorSectionProfessionalDetailsEmpty =>
      _t('لا توجد تفاصيل مهنية إضافية.', 'No additional professional details are listed.');
  String doctorInfoExperience(int years) => _t('الخبرة: $years سنة', 'Experience: $years years');
  String doctorInfoConsultationFee(String fee) => _t('رسوم الاستشارة: $fee شيكل', 'Consultation fee: $fee ILS');
  String doctorInfoConsultationDuration(int minutes) =>
      _t('مدة الاستشارة: $minutes دقيقة', 'Consultation duration: $minutes min');
  String doctorInfoRating(String rating) => _t('التقييم: $rating', 'Rating: $rating');
  String doctorInfoRatingWithCount(String rating, int count) =>
      _t('التقييم: $rating ($count تقييم)', 'Rating: $rating ($count ratings)');
  String doctorInfoMedicalLicense(String value) => _t('رقم الترخيص الطبي: $value', 'Medical license: $value');
  String get doctorSectionAssociatedClinics => _t('العيادات المرتبطة', 'Associated clinics');
  ...
  String get doctorSectionReviewsEmpty => _t('لا توجد تقييمات مدرجة.', 'No reviews are listed.');
  String get doctorReviewNoComment => _t('لا يوجد تعليق مكتوب', 'No written comment');
  ...
  String get doctorAvailabilityChooseDateHint =>
      _t('اختر تاريخًا لعرض الأوقات المتاحة.', 'Choose a date to view available times.');
  String get doctorAvailabilityNoneForDate =>
      _t('لا توجد أوقات متاحة لهذا التاريخ.', 'No times are available for this date.');

  // Discovery — clinic discovery
  String get clinicDiscoveryTitle => _t('ابحث عن رعاية صحية قريبة', 'Find healthcare nearby');
  ...
  String get searchClinicsFieldHint => _t('عيادة أو خدمة أو منطقة', 'Clinic, service, region');
  ...
  String get nearbySearchSubtitleInactive =>
      _t('استخدم GPS أو نقطة على الخريطة أو حيًا تقريبيًا في نابلس.', 'Use GPS, a map point, or an approximate Nablus-area district.');
  ...
  String get locationSourceManualMap => _t('نقطة يدوية على الخريطة', 'manual map');
  String get locationSourceManualDistrict => _t('حي تقريبي', 'approximate district');
  String get locationSourceNone => _t('لا شيء', 'none');
  String get clinicDiscoveryScreenTitle => _t('اكتشاف العيادات', 'Clinic discovery');
  ...
  String get pickMapPointHint =>
      _t('اضغط على الخريطة لاختيار نقطة بحث يدوية قريبة.', 'Tap the map to choose a manual nearby search point.');
  String clinicResultsCount(int count) => _t('$count نتيجة عيادة', '$count clinic result${count == 1 ? '' : 's'}');
  String get clinicLoadingClinics => _t('جارٍ تحميل العيادات...', 'Loading clinics...');
  String get clinicCouldNotLoadClinics => _t('تعذر تحميل العيادات', 'Could not load clinics');
  String get clinicEmptyTitle => _t('لم يتم العثور على عيادات', 'No clinics found');
  ...
  String get clinicNoMappedResults => _t('لا توجد نتائج عيادات على الخريطة.', 'No mapped clinic results.');
  ...
  String clinicTypeLabelFor(String? type) => switch ((type ?? '').trim().toLowerCase()) {
  ...
  String get clinicPendingVerificationLabel => _t('قيد التحقق', 'Pending verification');
  String get clinicUnverifiedLabel => _t('غير موثّقة / غير معروفة', 'Unverified / unknown');

  // Discovery — clinic detail
  String get clinicDetailTitle => _t('تفاصيل العيادة', 'Clinic details');
  String get clinicDetailLoadErrorTitle => _t('تعذر تحميل بيانات العيادة', 'Could not load clinic');
  String get clinicDetailNotFoundTitle => _t('العيادة غير موجودة', 'Clinic not found');
  String get clinicDetailNotFoundHint =>
      _t('قد لا تكون هذه العيادة متاحة بعد الآن.', 'This clinic may no longer be available.');
  String get clinicLoadingDetails => _t('جارٍ تحميل بيانات العيادة...', 'Loading clinic details...');
  ...
  String get clinicMapRoutingNote =>
      _t('التوجيه والاتجاهات غير مفعّلة في هذه المرحلة.', 'Routing and directions are not enabled in this phase.');
  String get clinicNoCoordinates =>
      _t('لا توجد إحداثيات خريطة مدرجة لهذه العيادة.', 'No map coordinates are listed for this clinic.');
  String get clinicsNoCoordinates =>
      _t('لا توجد إحداثيات خريطة مدرجة لهذه العيادات.', 'No map coordinates are listed for these clinics.');
  String get clinicContactSectionTitle => _t('التواصل والموقع', 'Contact and location');
  String get clinicNoContactDetails => _t('لا توجد تفاصيل تواصل مدرجة.', 'No contact details are listed.');
  ...
  String get clinicInsuranceTitle => _t('التأمين المقبول', 'Insurance accepted');
  ...
  String get clinicNoHoursListed => _t('لا توجد ساعات عمل مدرجة.', 'No operating hours are listed.');
  String get clinicDoctorsSectionTitle => _t('الأطباء في هذه المنشأة', 'Doctors at this facility');
  String get clinicNoDoctorsListed =>
      _t('لا يوجد أطباء مدرجون لهذه المنشأة.', 'No doctors are listed for this facility.');
  String clinicDoctorRatingLabel(String rating) => _t('التقييم $rating', 'Rating $rating');
  ...
  String get mapRecenterTooltip => _t('إعادة التمركز إلى موقعك', 'Recenter to your location');
  String get mapUserLocationMarkerLabel => _t('علامة موقعك', 'User location marker');
  String mapPlaceMarkerLabel(String label) => _t('علامة $label', '$label marker');
  ...
  String get noLocationSelected => _t('لم يتم تحديد موقع', 'No location selected');
  String get locationPrecisionApproximate => _t('تقريبي', 'Approximate');
  String get locationPrecisionExact => _t('دقيق', 'Exact');
  String locationStatusSourceLine(String status, String source) =>
      _t('الحالة: $status · المصدر: $source', 'Status: $status · Source: $source');
  String get selectManualMapPointHint =>
      _t('اضغط على الخريطة لتحديد نقطة يدويًا.', 'Tap the map to select a manual point.');
  ...
  String get useCurrentLocationButton => _t('استخدام الموقع الحالي', 'Use current location');
  String get selectPointOnMapButton => _t('اختيار نقطة على الخريطة', 'Select point on map');
  String get approximateDistrictTitle => _t('حي تقريبي', 'Approximate district');
  ...
  String get locationSettingsButton => _t('إعدادات الموقع', 'Location settings');
